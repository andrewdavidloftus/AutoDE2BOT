...
;* SSeg1 = Dist0 (left sonar)
;* SSeg2 = LeftD (Minimum distance we should see on left)
;* LCD = value of TOPD
;**********************************************
...
WCOUNT:   DW 0   ;Number of times that wall dist increased/decreased (PROBABLY DEPRECIATED)
...
Driving:             ; This method will eventually host wall tracking code entrance
  LOAD FMid
  STORE  DVel
...
NotOnRight:
  ...
  CALL CheckRange
  JNEG DriveOdometry     ; Continue driving for given distance
